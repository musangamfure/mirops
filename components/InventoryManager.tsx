...
const selStyle: React.CSSProperties = {
  ...
  fontSize: 13, fontFamily: "var(--font-serif), Georgia, serif", cursor: "pointer",
      ...
      <div style={{
        ...
        <div style={{ display: "flex", gap: 10 }}>
          <button onClick={onCancel} style={{
            ...
            color: "#9ab89a", fontSize: 14, cursor: "pointer", fontFamily: "var(--font-serif), Georgia, serif",
          }}>Cancel</button>
    ...
    <div style={{
      ...
      <button
        ...
        style={{
          ...
          fontFamily: "var(--font-serif), Georgia, serif", marginTop: 8,
        }}
        ...
        <div style={{ display: "flex", gap: 10, width: isMobile ? "100%" : "auto", flexDirection: isMobile ? "column" : "row" }}>
          <button
            ...
            style={{
              ...
              background: "#162214", color: "#4ade80", fontSize: 13, fontWeight: 700,
              cursor: "pointer", fontFamily: "var(--font-serif), Georgia, serif", width: isMobile ? "100%" : "auto",
          ...
          {(["movements", "batches"] as const).map((v) => (
            <button
              ...
              style={{
                ...
                fontSize: 12, fontWeight: 700, cursor: "pointer", fontFamily: "var(--font-serif), Georgia, serif",
              }}
